...
// from source file /Users/jared/clone/PJs/test/py2js/strings/rstrip0.py

load("pjs/data/pjslib.js");
var console = {log:function(){print.apply(this, arguments);}};
var window  = this;
module('/Users/jared/clone/PJs/test/py2js/strings/rstrip0.py', function (_) {
    _.__doc__ = "";
    _.s1 = $b.str('abc\n' +
    '\n' +
    '\n' +
