...
// from source file /Users/jared/clone/PJs/test/py2js/functions/bitand.py

load("pjs/data/pjslib.js");
var console = {log:function(){print.apply(this, arguments);}};
var window  = this;
module('/Users/jared/clone/PJs/test/py2js/functions/bitand.py', function (_) {
    _.__doc__ = "";
    _.x = 32424;
    _.y = 1437;
