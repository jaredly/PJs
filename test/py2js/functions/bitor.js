...
// from source file /Users/jared/clone/PJs/test/py2js/functions/bitor.py

load("pjs/data/pjslib.js");
var console = {log:function(){print.apply(this, arguments);}};
var window  = this;
module('/Users/jared/clone/PJs/test/py2js/functions/bitor.py', function (_) {
    _.__doc__ = "";
    _.x = 123215;
    _.y = 3423;
    _.z = $b.bitor(_.x, _.y);
