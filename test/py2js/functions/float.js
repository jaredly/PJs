...
// from source file /Users/jared/clone/PJs/test/py2js/functions/float.py

load("pjs/data/pjslib.js");
var console = {log:function(){print.apply(this, arguments);}};
var window  = this;
module('/Users/jared/clone/PJs/test/py2js/functions/float.py', function (_) {
    _.__doc__ = "";
    _.a = $b.str('123.456');
    _.b = $b._float(_.a);
    $b.print(_.b);//, true
