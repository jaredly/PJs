...
// from source file /Users/jared/clone/PJs/test/py2js/functions/lshift.py

load("pjs/data/pjslib.js");
var console = {log:function(){print.apply(this, arguments);}};
var window  = this;
module('/Users/jared/clone/PJs/test/py2js/functions/lshift.py', function (_) {
    _.__doc__ = "";
    _.x = 10;
    _.y = $b.lshift(_.x, 3);
    _.x = $b.lshift(_.x, 3);
