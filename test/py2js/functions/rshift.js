...
// from source file /Users/jared/clone/PJs/test/py2js/functions/rshift.py

load("pjs/data/pjslib.js");
var console = {log:function(){print.apply(this, arguments);}};
var window  = this;
module('/Users/jared/clone/PJs/test/py2js/functions/rshift.py', function (_) {
    _.__doc__ = "";
    _.x = 345;
    _.y = $b.rshift(_.x, 7);
    _.x = $b.rshift(_.x, 7);
