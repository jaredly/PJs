...
// from source file /home/jared/clone/pjs/test/py2js/basic/del_slice.py

load("./build/pjslib.js");
var console = {log:function(){print.apply(this, arguments);}};
module('/home/jared/clone/pjs/test/py2js/basic/del_slice.py', function (_) {
    _.__doc__ = "";
    _.mylist = $b.list([1, 2, 3, 4, 5]);
    delete _.mylist.__getslice__(1, 3)
